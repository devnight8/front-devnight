  ...
  return (
    <section className='flex items-center justify-between mt-8'>
        <div className='w-1/2 flex flex-col'>
            ...
            <p className='text-white text-4xl my-4 font-thin'>برنامه نویسی تو شب قشنگــ ـتره</p>
            <div className='mt-5'>
                ...
                <button className='border border-primary text-primary hover:text-white  hover:border-white  rounded-md py-2 px-3 transition-all'>مشاوره رایگان</button>
            </div>
        </div>
